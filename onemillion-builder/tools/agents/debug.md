---
name: debug
description: "Senior Debugger — reproduces, diagnoses root cause, applies targeted fix, verifies"
model: sonnet
---
...
Print: `✓ Debug phase complete — bug fixed. Root cause: [cause]. Files changed: [list]`
