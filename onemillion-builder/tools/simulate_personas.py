...
def scan_persona_friction(persona: dict) -> list[str]:
    ...
    single = (ROOT / "course/single.md").read_text()
    subdir_agents = (ROOT / "AGENTS.md").read_text()
    agents = (REPO / "AGENTS.md").read_text()
    orchestrator = (REPO / "onemillion-builder/agents/agents/orchestrator.md").read_text()
    teaching = (ROOT / "docs/teaching-protocol.md").read_text()
    day0 = (ROOT / "course/day-00-orientation/README.md").read_text()
    day1 = (ROOT / "course/day-01-idea/build.md").read_text()
    day4 = (ROOT / "course/day-04-design/build.md").read_text()
    day5 = (ROOT / "course/day-05-plan-architecture/build.md").read_text()
    day6 = (ROOT / "course/day-06-app-shell/build.md").read_text()
    day7 = (ROOT / "course/day-07-auth-db/build.md").read_text()
    day8 = (ROOT / "course/day-08-core-build/build.md").read_text()
    day10 = (ROOT / "course/day-10-qa-tests/build.md").read_text()
    day12 = (ROOT / "course/day-12-first-ai-build/build.md").read_text()
    day13 = (ROOT / "course/day-13-product-polish/build.md").read_text()
    day13_learn = (ROOT / "course/day-13-product-polish/learn.md").read_text()
    day14 = (ROOT / "course/day-14-security-trust-review/build.md").read_text()
    day15 = (ROOT / "course/day-15-qa-production-readiness/build.md").read_text()
    day16 = (ROOT / "course/day-16-ship-production/build.md").read_text()
    day18 = (ROOT / "course/day-18-demo/build.md").read_text()
